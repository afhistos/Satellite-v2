...
public class TextColor {
    //Couleurs classiques - Classic colors
    ...
    //Couleurs claires - Bright colors
    ...
    public static final String[] FOREGROUNDS = {BLACK,RED,GREEN,YELLOW,BLUE,PURPLE,CYAN,WHITE,BRIGHT_BLACK,BRIGHT_RED,
            BRIGHT_GREEN,BRIGHT_YELLOW,BRIGHT_BLUE,BRIGHT_PURPLE,BRIGHT_CYAN,BRIGHT_WHITE};

    //Couleurs classiques: Fond - Classic colors: Background
    ...
    //Couleurs claires: Fond - Bright colors: Background
    ...
    public static final String[] BACKGROUNDS = {BG_BLACK,BG_RED,BG_GREEN,BG_YELLOW,BG_BLUE,BG_PURPLE,BG_CYAN,BG_WHITE,
            BRIGHT_BG_BLACK,BRIGHT_BG_RED,BRIGHT_BG_GREEN,BRIGHT_BG_YELLOW,BRIGHT_BG_BLUE,BRIGHT_BG_PURPLE,BRIGHT_BG_CYAN,
            BRIGHT_BG_WHITE};
}
